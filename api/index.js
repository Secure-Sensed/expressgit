...
const handlers = {
  ...
  "admin/auth/login": require("../lib/api/admin/auth/login"),
  "admin/auth/session": require("../lib/api/admin/auth/session"),
  "admin/auth/logout": require("../lib/api/admin/auth/logout"),
